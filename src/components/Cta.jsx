...
import loket from "../assets/images/logo/loket.webp";
import intersect from "../assets/images/intersect.webp";
  ...
  return (
    <section className="container px-4 lg:px-20 text-left">
      <div className="relative bg-secondary rounded-2xl overflow-hidden grid gap-5 grid-cols-1 md:grid-cols-2  px-7 py-5 md:px-14 md:py-10">
        <img src={intersect} alt="intersect.webp" className="absolute h-2/3 md:h-full -top-6 md:top-0 md:rotate-0 rotate-12 md:-left-52" />
        ...
        <div className="flex items-center justify-center md:justify-end">
          <div className="rounded-xl max-w-[25rem] bg-white p-5 w-full">
            ...
            <button className="flex items-center justify-center w-full border border-b-2 border-primary rounded-lg py-2">
              <div className="flex items-center gap-4">
                <img src={loket} className="w-8 h-8 md:w-10 md:h-10" alt="loket.webp" />

      ...
      <div className="flex flex-col my-2 mt-4">
        ...
        */}
        <div className="md:flex md:flex-row md:justify-between md:items-center my-1">
          <p className="md:justify-start text-black text-3xl lg:text-6xl text-center lg:text-start font-bold tracking-widest space-y-2">
        ...
        <div className="flex flex-col lg:flex-row lg:justify-between my-2">
          <p className="m-2 text-center lg:text-start font-bold lg:font-normal lg:justify-start">
            Mengalami keajaiban dalam 3D, petualangan yang memukau yang
            mempersembahkan keindahan laut secara visual dan mendalam
          </p>
          <p className="m-2 text-center lg:text-start font-bold lg:font-normal lg:justify-end">
